...
% \begin{lemma}
%     \label{ch3:lm:internal-hom-agree-on-cofree}
...
% \begin{lemma}
%     \label{ch3:lm:relative-tensor-agree-on-free}
...
\begin{definition}
    %\label{ch3:def:internal-hom-contra}
...
\begin{theorem}
    %\label{ch3:thm:positselski-duality-adjunction}
...
\begin{corollary}
    %\label{ch3:cor:positselski-duality-kleisli}
...
\begin{lemma}
    %\label{ch3:lm:separable-coalgebra-if-separable-forgetful}
...
\begin{corollary}
    %\label{ch3:cor:comod-over-separable-are-cofree}
