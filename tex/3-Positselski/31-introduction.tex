...
Using a dual version of Barr--Beck monadicity, see \cref{ch3:ssec:dual-barr-beck}, one can prove that 
...
This is a special case of our second main theorem, \cref{ch3:introthm:B}, which is an application of the Positselski duality for $\E_\infty$-coalgebras  set up in \cref{ch3:introthm:A}. 
...
\begin{introthm}[{\cref{ch3:thm:Positselski-duality-idempotent}}]
    \label{ch3:introthm:A}
...
\begin{introthm}[{\cref{ch3:thm:local-duality-co-contra}}]
    \label{ch3:introthm:B}
