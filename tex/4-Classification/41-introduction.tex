...
Our second main theorem provides an extension of this correspondence to the stable $\infty$-category $\C$, allowing us to strengthen \cref{ch4:thm:A} to non-weak localizing sucategories. This interacts well with existing classifications of localizing subcategories in modules over noetherian rings and quasicoherent sheaves on noetherian schemes. 
...
\begin{introthm}[{\cref{ch4:thm:main}}]
    \label{ch4:thm:B}
...
\textbf{Linear overview:} We start \cref{ch4:sec:prestable-and-stable-categories} with some recollections on $t$-structures, prestable $\infty$-categories, and their interactions, before we introduce the notion of localizing subcategories in \cref{ch4:ssec:localizing-subcategories}. We then study some further interactions between these, which we use to prove \cref{ch4:thm:A} in \cref{ch4:ssec:classificartion-weak-localizing} and \cref{ch4:thm:B} in \cref{ch4:ssec:classificartion-localizing}. We finish the paper by looking at some consequences and applications of our results. 
