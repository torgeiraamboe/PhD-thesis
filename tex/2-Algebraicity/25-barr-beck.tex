...
\begin{definition}
    \index{Monoidal Barr--Beck adjunction}
...
\begin{definition}
    \index{Map of local duality contexts}
...
\begin{proof}
    ...
    By \cref{ch1:lm:induced-torsion-adjunction} $F'$ is symmetric monoidal, hence $F(\Gamma_\K\1_\C)\simeq \Gamma_\L \1_\D$, which acts on $X$ as the monoidal unit. Thus, we can summarize with
