...
\begin{definition}
    \index{Thick subcategory!Stable}
...
\end{lemma}
\begin{proof}
    Let $\L$ be an arbitrary localizing subcategory of $\C$. The right-orthogonal complement\index{Right orthgonal complement} of $\L$, denoted
