...
\begin{lemma}
    The category of connected $E$-local synthetic spectra $\LSynE$ is Postnikov complete.  
\end{lemma}
\begin{proof}
...
\begin{corollary}
    The category of connected monochromatic synthetic spectra $\MSynE$ is Postnikov complete. 
\end{corollary}
\begin{proof}
    Add
\end{proof}
