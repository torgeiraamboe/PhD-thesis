...
\[U_M\: \LMod_M(\D)\to \D.\] 
By \cite[4.2.4.8]{Lurie_HA} this functor admits a left adjoint $F_M\: \D\to \LMod_M(\D)$ given on objects by $X\longmapsto MX$. We call this the \emph{free module} functor. The adjunction $F_M\dashv U_M$ is called the \emph{free-forgetful} adjunction of $M$. 
...
The free-forgetful adjunction restricts to an adjunction on the Kleisli category: $F_M:\D\rightleftarrows \LMod_M\fr(\D):U_M\fr$. By \cite[1.8]{christ_2023} this is the minimal adjunction with adjunction monad equivalent to $M$---in particular, the forgetful functor $U_M\fr$ is fully faithful.  
...
We now state the monoidal Barr--Beck theorem of Mathew--Naumann--Noel. 
