...
Our restricted homology theory $E_*\colon \M_{n,p}\longrightarrow \Comodt$ should then be associated to a deformation $\hSynE\Int$ coming from a local duality theory for $\hSynE$, in the sense that there is a diagram of stable $\infty$-categories 
\begin{center}
    \begin{tikzcd}
        \M_{n,p}\simeq\Sp\np\Int & \hSynE\Int \arrow[l, "\tau^{-1}"'] \arrow[r, "\tau\sim 0"] & \Fr\np\Int.
    \end{tikzcd}    
\end{center}
